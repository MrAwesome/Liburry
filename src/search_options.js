...
exports.DATABASES = exports.DEFAULT_HOABUN_INDEX = exports.DEFAULT_POJ_UNICODE_INDEX = exports.DEFAULT_ENGLISH_INDEX = exports.DEFAULT_POJ_INPUT_INDEX = exports.DEFAULT_POJ_NORMALIZED_INDEX = exports.DISPLAY_RESULTS_LIMIT = void 0;
...
const POJ_INPUT_SHORTNAME = "i";
const ENGLISH_SHORTNAME = "e";
const HOABUN_SHORTNAME = "h";
const DEFAULT_SHORTNAME_TO_PREPPED_NAME_MAPPING = new Map([
...
const DEFAULT_SEARCH_KEYS = Array.from(DEFAULT_SHORTNAME_TO_PREPPED_NAME_MAPPING.values());
...
exports.DEFAULT_POJ_INPUT_INDEX = DEFAULT_SEARCH_KEYS.indexOf(POJ_INPUT_PREPPED_KEY);
