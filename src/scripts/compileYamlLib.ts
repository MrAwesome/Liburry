...
export function getTypeScriptHelperDefinitionsFromConfig(rfc: ReturnedFinalConfig): {filename: string, contents: string, after: () => Promise<void>}[] {
    ...
    const varName = "i18nTokens";
    const knownTokensAsTypeUnionInner = knownTokens.join('" | "');
    const i18nFileContents = `// XXX :: Automatically generated by src/scripts/compileYamlLib.ts - DO NOT EDIT THIS FILE BY HAND! :: XXX
type ${varName} = "${knownTokensAsTypeUnionInner}";
